            ...
            <div className="lobby-card">
                        ...
                        <div className="player-details">
                            ...
                            {balance < 1 && (
                                <p className="status-alert">
                                    You have run out of credits! Create a new
                                    player to get $100.
                                </p>
                            )}
                        </div>
                ...
                <section className="rules-card">
                    ...
                    <ul className="rules-list">
                        <li>
                            <strong>Goal:</strong> Build a hand of at least a
                        ...
                        <li>
                            ...
                            <strong>HOLD</strong>) and click{" "}
                            <strong>DRAW</strong>.
                        </li>
                        <li>
                            <strong>Payout:</strong> The payout table is
                            multiplied by the size of your bet (1–5).
                        </li>
                    </ul>
                </section>
